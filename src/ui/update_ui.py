...
def anchor_left_cascade_submenu(submenu: QMenu, parent_menu: QMenu) -> None:
    """Keep a tray submenu immediately left of its parent menu."""
...
def install_left_cascade_submenu(submenu: QMenu, parent_menu: QMenu) -> None:
    ...
    submenu.aboutToShow.connect(
        lambda: QTimer.singleShot(
            0,
            lambda: anchor_left_cascade_submenu(submenu, parent_menu),
        )
    )
